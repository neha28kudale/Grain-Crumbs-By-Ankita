...
//   BadgeCheck, CheckCircle2, Star, Cookie, Sparkles, Users
// } from "lucide-react";
...
//         name: "description",
//         content:
//           "Grain Crumbs Cookie Cake Tins — classic and millet cookies, beautifully packed for gifting. Launching soon.",
//       },
//       { property: "og:title", content: "Cookie Cake Tins — Coming Soon" },
//       {
//         property: "og:description",
//         content: "Handcrafted Cookie Cake Tins for gifting. Classic and millet varieties. Coming soon from Grain Crumbs.",
//       },
//     ],
//   }),
//   component: Page,
...
//   { feature: "Base Ingredients", classic: "Traditional bakery ingredients", millet: "Millet-based ingredients" },
//   { feature: "Sweetener", classic: "Refined sugar", millet: "Jaggery" },
//   { feature: "Texture", classic: "Buttery & indulgent", millet: "Rustic & wholesome" },
//   { feature: "Best For", classic: "Celebrations & gifting", millet: "Mindful everyday snacking" },
//   { feature: "Flavour Profile", classic: "Rich, bakery-style", millet: "Wholesome with unique grain notes" },
//   { feature: "Perfect For", classic: "Cookie lovers", millet: "Families seeking wholesome alternatives" },
// ];
...
//           <Reveal delay={150}>
//             <div
//               className="relative overflow-hidden rounded-[2rem] shadow-[var(--shadow-warm)]"
//               style={{ maskImage: "radial-gradient(ellipse 85% 90% at 50% 50%, black 42%, transparent 84%)" }}
//             >
//               <img
//                 src="/assets/grain-crumbs/cookie-tins/cookie-main-new.png"
//                 alt="Beautifully arranged Cookie Cake Tin with assorted cookies"
//                 width={900}
//                 height={1000}
...
//       {/* ── SECTION 01: TWO RANGES — text left, image right ── */}
...
//               At Grain Crumbs, we believe everyone deserves cookies they love.
//             </p>
//             <p className="mt-3 text-muted-foreground">
//               Our upcoming collection will feature two thoughtfully crafted ranges:
//             </p>
...
//                   Timeless flavours made for pure indulgence.
//                 </p>
//               </div>
//               <div className="card-warm p-5">
//                 <div className="flex items-center gap-3">
...
//                 </div>
//                 <p className="mt-2 text-sm text-muted-foreground">
//                   Wholesome creations made with nourishing millets and jaggery.
//                 </p>
//               </div>
//             </div>
//             <p className="mt-5 text-sm text-muted-foreground italic">
//               Whichever you choose, every batch will be baked fresh, in small quantities and with the same Grain Crumbs love.
//             </p>
//           </Reveal>
//           <Reveal delay={150}>
//             <div
//               className="overflow-hidden rounded-[2rem]"
//               style={{ maskImage: "radial-gradient(ellipse 88% 88% at 50% 50%, black 40%, transparent 82%)" }}
//             >
//               <img
//                 src="/assets/grain-crumbs/cookie-tins/Choose-cookie.png"
//                 alt="Classic and millet cookies side by side"
//                 width={800}
//                 height={900}
//                 loading="lazy"
//                 className="h-full w-full object-cover"
...
//       {/* ── SECTION 02: CLASSIC — image left, text right ── */}
...
//             >
//               <img
//                 src="assets\grain-crumbs\cookie-tins\classic-cookie.png"
//                 alt="Luxurious classic Cookie Cake Tin with chocolate chip and butter cookies"
//                 width={800}
//                 height={900}
//                 loading="lazy"
//                 className="h-full w-full object-cover"
...
//             <HeartDivider />
//             <p className="mt-5 text-muted-foreground">
//               For those who love traditional bakery-style cookies.
//             </p>
//             <p className="mt-3 text-muted-foreground">
//               Expect rich flavours, comforting textures and familiar favourites — perfect for celebrations, gifting and sharing with loved ones.
//             </p>
//             <div className="mt-5">
//               <p className="text-sm font-semibold uppercase tracking-[0.2em] text-[color:var(--chocolate)]">Potential Flavours</p>
//               <div className="mt-3 flex flex-wrap gap-2">
//                 {["Chocolate Chunk", "Double Chocolate", "Butter Cookies", "Biscoff", "Nutty Delights", "Seasonal Specials"].map((f) => (
//                   <span key={f} className="rounded-full border border-border bg-card px-3 py-1 text-xs font-medium">
//                     {f}
//                   </span>
//                 ))}
//               </div>
...
//       {/* ── SECTION 03: MILLET — text left, image right ── */}
//       <section className="section">
//         <div className="container-prose grid items-center gap-12 md:grid-cols-2">
//           <Reveal>
...
//             <HeartDivider />
//             <p className="mt-5 text-muted-foreground">
//               Our millet Cookie Cake Tins are thoughtfully crafted using wholesome ingredients including millets and jaggery, bringing together nourishment and delicious flavours.
//             </p>
//             <p className="mt-3 text-muted-foreground">
//               Perfect for families looking for mindful snacking options without compromising on taste.
//             </p>
//             <div className="mt-6 grid grid-cols-1 gap-3 sm:grid-cols-2">
...
//             >
//               <img
//                 src="/assets/grain-crumbs/cookie-tins/millet-cookie.png"
//                 alt="Rustic millet cookies surrounded by ragi, oats, foxtail millet and jaggery"
//                 width={800}
//                 height={900}
//                 loading="lazy"
//                 className="h-full w-full object-cover"
...
//       {/* ── SECTION 04: GIFTING — image left, text right ── */}
//       <section className="section bg-[color:var(--cream-dark)]/40">
//         <div className="container-prose grid items-center gap-12 md:grid-cols-2">
//           <Reveal>
//             <div
...
//             >
//               <img
//                 // src="https://images.unsplash.com/photo-1607344645866-009c320b63e0?w=800&q=85&fit=crop"
//                 src="/assets/grain-crumbs/gifting-hamper.png"
//                 alt="Beautifully packed Cookie Cake Tin gift with ribbons and dried flowers"
//                 width={800}
//                 height={900}
//                 loading="lazy"
//                 className="h-full w-full object-cover"
...
//             <HeartDivider />
//             <p className="mt-5 text-muted-foreground">
//               Whether it's birthdays, festivals, return gifts, corporate gifting or simply sending love, our Cookie Cake Tins are designed to make every occasion memorable.
//             </p>
//             <p className="mt-3 text-muted-foreground">
//               Beautiful packaging and handcrafted cookies come together to create gifts people truly remember.
//             </p>
//             <div className="mt-6 grid grid-cols-1 gap-3 sm:grid-cols-2">
...
//                     <th className="px-4 py-5 sm:px-8">Classic Cookie Cake Tin</th>
//                     <th className="px-4 py-5 text-[color:var(--gold)] sm:px-8">Millet Cookie Cake Tin</th>
//                   </tr>
//                 </thead>
//                 <tbody>
...
//               We're currently testing recipes and flavours to bring you the perfect Cookie Cake Tin experience.
//             </p>
//           </Reveal>
...
//                 Join our waitlist and we'll let you know the moment Cookie Cake Tins are available.
//               </p>
//             </Reveal>
...
//                 Handcrafted cookies. Small batches. Made with love.
//               </h2>
//               <p className="relative mx-auto mt-4 max-w-lg text-[color:var(--cream)]/80 text-sm">
//                 We're carefully testing flavours, textures and packaging to create Cookie Cake Tins you'll truly love.
//               </p>
        ...
        <div className="container-prose grid items-center gap-12 md:grid-cols-2">
          ...
          <Reveal delay={150}>
            ...
            <div className="mt-5 rounded-2xl border border-[color:var(--gold)]/30 bg-[color:var(--cream-dark)]/50 p-5">
              <p className="mb-2 flex items-center gap-2 text-xs font-semibold uppercase tracking-[0.18em] text-[color:var(--chocolate)]">
            ...
            <div className="mt-5">
              ...
              <div className="mt-3 flex flex-wrap gap-2">
                {["Oozy Dark Chocolate", "Red Velvet", "Pistachio", "Biscoff"].map((f) => (
                  <span key={f} className="rounded-full border border-[color:var(--gold)]/40 bg-[color:var(--cream-dark)]/60 px-3 py-1 text-xs font-medium">
                    {f}
                  </span>
                ))}
              </div>
